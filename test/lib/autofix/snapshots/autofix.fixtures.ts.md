...
> AutofixResult iteration #0: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/ui/dom/includeStylesheet", "sap/ui/dom/units/Rem", "sap/ui/events/checkMouseEnterOrLeave", "sap/ui/events/ControlEvents", "sap/ui/events/F6Navigation", "sap/ui/events/jquery/EventSimulation",␊
     ...
     denormalizeScrollLeftRTL, getOwnerWindow, getScrollbarSize, includeScript, includeStylesheet, Rem, checkMouseEnterOrLeave, ControlEvents, F6Navigation, EventSimulation, KeyCodes, PseudoEvents,␊
     TouchToMouseMapping, Measurement, FESR, Interaction, Passport, FrameOptions, Mobile, Storage, XMLHelper) {␊
...
## General: ambiguousEventHandlers/BadControllerName.view.xml

> LintResult: ambiguousEventHandlers/BadControllerName.view.xml
    ...
    [
      {
        ...
        errorCount: 3,
        fatalErrorCount: 0,
        filePath: 'BadControllerName.view.xml',
        messages: [
          {
            column: 10,
            line: 5,
          ...
          },
          {
            column: 10,
            line: 8,
            message: 'Event handler \'onPressFancyButtonArrow\' must be prefixed by a dot \'.\' or refer to a local name',
            messageDetails: 'If the handler is defined on the controller, use the leading dot notation. Otherwise import the module via core:require and use the handler via the local name. See Handling Events in XML Views (https://ui5.sap.com/#/topic/b0fb4de7364f4bcbb053a99aa645affe)',
            ruleId: 'no-ambiguous-event-handler',
            severity: 1,
            ui5TypeInfo: undefined,
          },
          {
            column: 10,
            line: 11,
            message: 'Access of global variable \'eventHandlers\' (eventHandlers.onPressFancyButton)',
            messageDetails: 'Do not use global variables to access UI5 modules or APIs. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
            ruleId: 'no-globals',
            severity: 2,
            ui5TypeInfo: undefined,
          },
          {
            column: 10,
            line: 14,
            message: 'Access of global variable \'baseEventHandlers\' (baseEventHandlers.oneLevelDeeper.onPressButton)',
            messageDetails: 'Do not use global variables to access UI5 modules or APIs. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
            ruleId: 'no-globals',
            severity: 2,
            ui5TypeInfo: undefined,
          },
          {
            column: 10,
            line: 17,
            message: 'Access of global variable \'eventHandlers\' (eventHandlers.onPressFancyButtonNonExisting)',
            messageDetails: 'Do not use global variables to access UI5 modules or APIs. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
            ruleId: 'no-globals',
            severity: 2,
            ui5TypeInfo: undefined,
          },
          {
            column: 10,
            line: 20,
            message: 'Event handler \'onBaseControllerHandler\' must be prefixed by a dot \'.\' or refer to a local name',
            messageDetails: 'If the handler is defined on the controller, use the leading dot notation. Otherwise import the module via core:require and use the handler via the local name. See Handling Events in XML Views (https://ui5.sap.com/#/topic/b0fb4de7364f4bcbb053a99aa645affe)',
            ruleId: 'no-ambiguous-event-handler',
            severity: 1,
            ui5TypeInfo: undefined,
          },
          {
            column: 10,
            line: 23,
            message: 'Event handler \'byId\' must be prefixed by a dot \'.\' or refer to a local name',
            messageDetails: 'If the handler is defined on the controller, use the leading dot notation. Otherwise import the module via core:require and use the handler via the local name. See Handling Events in XML Views (https://ui5.sap.com/#/topic/b0fb4de7364f4bcbb053a99aa645affe)',
            ruleId: 'no-ambiguous-event-handler',
            severity: 1,
            ui5TypeInfo: undefined,
          ...
          },
          {
            column: 10,
            line: 29,
            message: 'Event handler \'onUnknownHandler\' must be prefixed by a dot \'.\' or refer to a local name',
            messageDetails: 'If the handler is defined on the controller, use the leading dot notation. Otherwise import the module via core:require and use the handler via the local name. See Handling Events in XML Views (https://ui5.sap.com/#/topic/b0fb4de7364f4bcbb053a99aa645affe)',
            ruleId: 'no-ambiguous-event-handler',
            severity: 1,
            ui5TypeInfo: undefined,
...
## General: ambiguousEventHandlers/Base.controller.js

> LintResult: ambiguousEventHandlers/Base.controller.js
    ...
    [
      {
        ...
        errorCount: 0,
        fatalErrorCount: 0,
        filePath: 'Base.controller.js',
        messages: [],
        warningCount: 0,
      },
    ]

## General: ambiguousEventHandlers/BaseTs.controller.ts

> LintResult: ambiguousEventHandlers/BaseTs.controller.ts
    ...
    [
      {
        ...
        errorCount: 0,
        fatalErrorCount: 0,
        filePath: 'BaseTs.controller.ts',
        messages: [],
        warningCount: 0,
      },
    ]

## General: ambiguousEventHandlers/Main.controller.js

> LintResult: ambiguousEventHandlers/Main.controller.js
...
## General: ambiguousEventHandlers/Main.view.xml

> AutofixResult iteration #0: /ambiguousEventHandlers/Main.view.xml

    `<mvc:View xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc" xmlns:core="sap.ui.core"␊
    	controllerName="ui5.walkthrough.controller.Main">␊
    ␊
    	<!-- Local event handler -->␊
    	<Button press=".onPressFancyButton" /> <!-- Autofix -->␊
    ␊
    	<!-- Local event handler -->␊
    	<Button press=".onPressFancyButtonArrow" /> <!-- Autofix -->␊
    ␊
    	<!-- Local event handler (nested) -->␊
    	<Button press=".eventHandlers.onPressFancyButton" /> <!-- Autofix -->␊
    ␊
    	<!-- Local event handler (nested, inherited) -->␊
    	<Button press=".baseEventHandlers.oneLevelDeeper.onPressButton" /> <!-- Autofix -->␊
    ␊
    	<!-- Local NON-existing event handler (nested) -->␊
    	<Button press="eventHandlers.onPressFancyButtonNonExisting" /> <!-- Do not Autofix: non existent event -->␊
    ␊
    	<!-- Local event handler (Inherited: BaseController) -->␊
    	<Button press=".onBaseControllerHandler" /> <!-- Autofix -->␊
    	␊
    	<!-- Not a real event handler, but an existing method in sap.ui.mvc.Controller (Inherited: sap.ui.mvc.Controller) -->␊
    	<Button press=".byId" /> <!-- Autofix -->␊
    ␊
    	<!-- Local event handler (with arguments) -->␊
    	<Button press=".onPressFancyButton(0, ${i18n>LABEL_ALL}, $controller.foo.bar, $event)" /> <!-- Autofix -->␊
    ␊
    	<!-- Unknown to the controller event handler -->␊
    	<Button press="onUnknownHandler" /> <!-- Should not be autofixed -->␊
    ␊
    	<!-- Command Execution -->␊
    	<Button press="cmd:Save" /> <!-- Should not be autofixed -->␊
    ␊
    	<!-- Empty event handler -->␊
    	<Button press="" /> <!-- Should not be autofixed -->␊
    ␊
    	<!-- Usage of event handler imported via core:require helper -->␊
    	<Button core:require='{ "MyHelper": "ui5/walkthrougth/utils/MyHelper" }' press="MyHelper.onPressFancyButton" /> <!-- Should not be autofixed -->␊
    ␊
    	<!-- Usage of event handler function imported via core:require -->␊
    	<Button core:require='{ "doSomething": "ui5/walkthrougth/utils/doSomething" }' press="doSomething" /> <!-- Should not be autofixed -->␊
    ␊
    </mvc:View>`

> LintResult: ambiguousEventHandlers/Main.view.xml
...
## General: ambiguousEventHandlers/MainTs.controller.ts

> LintResult: ambiguousEventHandlers/MainTs.controller.ts
    ...
    [
      {
        ...
        errorCount: 0,
        fatalErrorCount: 0,
        filePath: 'MainTs.controller.ts',
        messages: [],
        warningCount: 0,
      },
    ]

## General: ambiguousEventHandlers/MainTs.view.xml

> AutofixResult iteration #0: /ambiguousEventHandlers/MainTs.view.xml

    `<mvc:View xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc" xmlns:core="sap.ui.core"␊
    	controllerName="ui5.walkthrough.controller.MainTs">␊
    ␊
    	<!-- Local event handler -->␊
    	<Button press=".onPressFancyButton" /> <!-- Autofix -->␊
    ␊
...
> LintResult: ambiguousEventHandlers/MainTs.view.xml
...
## General: ambiguousEventHandlers/NoControllerName.view.xml

> LintResult: ambiguousEventHandlers/NoControllerName.view.xml
    ...
    [
      {
        ...
        errorCount: 3,
        fatalErrorCount: 0,
        filePath: 'NoControllerName.view.xml',
        messages: [
          {
            column: 10,
            line: 4,
...
## General: bootstrapParameters/BootstrapParameters_CompatVersion.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_CompatVersion.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with compat-version=edge -> binding-syntax attributes w/ complex should be removed</title>␊
...
> LintResult: bootstrapParameters/BootstrapParameters_CompatVersion.html

    []

## General: bootstrapParameters/BootstrapParameters_CompatVersion2.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_CompatVersion2.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with compat-version=edge (+random order) -> binding-syntax attributes w/ complex should be removed</title>␊
    	<script␊
    		id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
...
> LintResult: bootstrapParameters/BootstrapParameters_CompatVersion2.html

    []

## General: bootstrapParameters/BootstrapParameters_CompatVersion3.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_CompatVersion3.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with NO compat-version=edge -> binding-syntax attributes should NOT be removed (except for duplicates)</title>␊
    	<!-- + camelCase should be replaced with kebab-case -->␊
    	<script id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
    		data-sap-ui-theme="sap_horizon"␊
...
> LintResult: bootstrapParameters/BootstrapParameters_CompatVersion3.html
    ...
    [
      {
        ...
        errorCount: 1,
        fatalErrorCount: 0,
        filePath: 'BootstrapParameters_CompatVersion3.html',
        messages: [
          {
            column: 31,
            line: 11,
          ...
          },
          {
            ...
            messageDetails: 'Defining the binding syntax is not necessary if \'data-sap-ui-compat-version="edge"\' is set.',
            ruleId: 'no-deprecated-api',
            severity: 1,
            ui5TypeInfo: undefined,
          },
...
## General: bootstrapParameters/BootstrapParameters_CompatVersion4.html

> LintResult: bootstrapParameters/BootstrapParameters_CompatVersion4.html
    ...
    [
      {
        ...
        errorCount: 1,
        fatalErrorCount: 0,
        filePath: 'BootstrapParameters_CompatVersion4.html',
        messages: [
          {
            column: 3,
            line: 12,
            message: 'Redundant bootstrap parameter \'data-sap-ui-binding-syntax\' should be removed',
            messageDetails: 'Only \'complex\' is supported with UI5 2.x and automatically enforced by the UI5 runtime. Check all bindings whether they will be misinterpreted in 2.x with binding syntax \'complex\'. Also, defining the binding syntax is not necessary if \'data-sap-ui-compat-version="edge"\' is set.',
            ruleId: 'no-deprecated-api',
            severity: 2,
            ui5TypeInfo: undefined,
          },
...
## General: bootstrapParameters/BootstrapParameters_CompatVersion5.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_CompatVersion5.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with compat-version=edge -> binding-syntax attributes w/ complex should be removed</title>␊
    	<!-- + binding-syntax=simple is a duplicate and thus should be removed -->␊
    	<script id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
    		data-sap-ui-theme="sap_horizon"␊
...
> LintResult: bootstrapParameters/BootstrapParameters_CompatVersion5.html

    []

## General: bootstrapParameters/BootstrapParameters_Deprecations.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_Deprecations.html
    ...
    ␊
    		...
    		data-sap-ui-modules="sap.m.library, sap.ui.commons.library"␊
    		...
    		␊
    		data-sap-ui-a-b-a-p-date-format=""␊
    		data-sap-ui-a-b-a-p-time-format=""␊
...
> LintResult: bootstrapParameters/BootstrapParameters_Deprecations.html
    ...
    [
      {
        ...
        messages: [
          ...
          },
          {
            ...
            messageDetails: 'Set the manifest parameter in component factory call sap.ui.core.Component#sap.ui.core.Component.create (https://ui5.sap.com/1.136/#/api/sap.ui.core.Component%23methods/sap.ui.core.Component.create)',
            ruleId: 'no-deprecated-api',
            severity: 2,
            ui5TypeInfo: undefined,
          },
...
## General: bootstrapParameters/BootstrapParameters_Deprecations2.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_Deprecations2.html
...
> LintResult: bootstrapParameters/BootstrapParameters_Deprecations2.html
...
## General: bootstrapParameters/BootstrapParameters_Deprecations3.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_Deprecations3.html
...
> LintResult: bootstrapParameters/BootstrapParameters_Deprecations3.html
...
## General: bootstrapParameters/BootstrapParameters_DuplicateAttribute.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_DuplicateAttribute.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with Duplicate Attribute (only first should be kept & every other should be removed)</title>␊
    	<script id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
    		data-sap-ui-theme="sap_horizon"␊
    		data-sap-ui-async="true"␊
    		data-sap-ui-compat-version="edge"␊
    		data-sap-ui-on-init="module:my/init/function"␊
    		data-sap-ui-animation-mode="full"␊
    		data-sap-ui-flexibility-services="true" data-sap-ui-log-level="ERROR"␊
    		>␊
    	</script>␊
    </head>␊
    <body class="sapUiBody">␊
...
> LintResult: bootstrapParameters/BootstrapParameters_DuplicateAttribute.html

    []

## General: bootstrapParameters/BootstrapParameters_MultipleScripts.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_MultipleScripts.html
    ...
    <head>␊
    	<meta charset="utf-8">␊
    	<meta name="viewport" content="width=device-width, initial-scale=1.0">␊
    	<title>Sample index.html with multiple scripts (only bootstrap script should be autofixed)</title>␊
    	<link rel="icon" href="data:,">␊
    	<script id="foo"␊
...
> LintResult: bootstrapParameters/BootstrapParameters_MultipleScripts.html
...
## General: bootstrapParameters/BootstrapParameters_MultipleScripts2.html

> LintResult: bootstrapParameters/BootstrapParameters_MultipleScripts2.html
...
## General: bootstrapParameters/BootstrapParameters_MultipleScripts3.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_MultipleScripts3.html
    ...
    <head>␊
    	<meta charset="utf-8">␊
    	<meta name="viewport" content="width=device-width, initial-scale=1.0">␊
    	<title>Sample index.html with multiple BOOTSTRAP scripts (only the first bootstrap script should be autofixed)</title>␊
    	<link rel="icon" href="data:,">␊
    	<script id="foo"␊
    		src="thirdparty/jquery.js"␊
    ␊
...
> LintResult: bootstrapParameters/BootstrapParameters_MultipleScripts3.html
    ...
    [
      {
        ...
        errorCount: 2,
        fatalErrorCount: 0,
        filePath: 'BootstrapParameters_MultipleScripts3.html',
        messages: [
          {
            column: 2,
            line: 25,
...
## General: bootstrapParameters/BootstrapParameters_SpacesTabsLinebreaks.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_SpacesTabsLinebreaks.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with more edge cases within attributes (spaces, tabs & linebreaks)</title>␊
    	<script id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
    		data-sap-ui-async="true"␊
    		data-sap-ui-resource-roots= '{"sap.ui.demo.todo": "./"}'␊
    		data-sap-ui-flexibility-services=  "true"␊
    		data-sap-ui-compat-version=	"edge"␊
    		data-sap-ui-on-init=␊
    		"module:my/init/function"␊
    		data-sap-ui-animation-mode ="full"␊
...
> LintResult: bootstrapParameters/BootstrapParameters_SpacesTabsLinebreaks.html

    []

## General: bootstrapParameters/BootstrapParameters_SpacesTabsLinebreaks2.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_SpacesTabsLinebreaks2.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Sample index.html with more edge cases within attributes (no spaces between attributes)</title>␊
    	<script id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
    		data-sap-ui-a-b-a-p-date-format="yMMMd"data-sap-ui-a-b-a-p-time-format="hh:mm:ss"␊
    		data-sap-ui-async="true"␊
    		data-sap-ui-resource-roots='{"sap.ui.demo.todo": "./"}'data-sap-ui-compat-version="edge"␊
    		data-sap-ui-on-init="module:my/init/function"␊
    		data-sap-ui-animation-mode="full"data-sap-ui-log-level="INFO"␊
    		>␊
    	</script>␊
    </head>␊
    <body class="sapUiBody">␊
...
> LintResult: bootstrapParameters/BootstrapParameters_SpacesTabsLinebreaks2.html

    []

## General: bootstrapParameters/BootstrapParameters_SpecialAttributes.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_SpecialAttributes.html

    `<html>␊
    <head>␊
    	<title>Special attributes (one character long, w/ or w/o values)</title>␊
    	<script id="sap-ui-bootstrap"␊
    		a="abc"␊
    		,␊
    		x␊
...
> LintResult: bootstrapParameters/BootstrapParameters_SpecialAttributes.html
    ...
    [
      {
        ...
        errorCount: 2,
        fatalErrorCount: 0,
        filePath: 'BootstrapParameters_SpecialAttributes.html',
        messages: [
          {
            column: 2,
            line: 4,
...
## General: bootstrapParameters/BootstrapParameters_UnquotedAttributeValues.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_UnquotedAttributeValues.html

    `<!Doctype HTML>␊
    <html>␊
    <head>␊
    	<title>Duplicated attributes should be removed (test values without quotes)</title>␊
    	<script id="sap-ui-bootstrap"␊
    		type="text/javascript"␊
    		src="resources/sap-ui-core.js"␊
    		data-sap-ui-animation-mode="full"␊
    		...
    		data-sap-ui-libs=sap.m␊
    		attr=abc ignore=xyz␊
    		attr2=abc ignore2=xyz␊
    		attr3="abc" ignore3=xyz␊
    		attr4="abc" ignore4=xyz␊
    		attr5="abc"ignore5=xyz␊
    		attr6="abc"ignore6=xyz␊
    		doubleAndSingleQuoted="edge"␊
    		doubleAndSingleQuoted2='edge'>␊
    	</script>␊
    </head>␊
    <body class="sapUiBody">␊
    </body>␊
...
> LintResult: bootstrapParameters/BootstrapParameters_UnquotedAttributeValues.html

    []

## General: bootstrapParameters/BootstrapParameters_UnquotedAttributeValues2.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_UnquotedAttributeValues2.html
...
> LintResult: bootstrapParameters/BootstrapParameters_UnquotedAttributeValues2.html

    []

## General: bootstrapParameters/BootstrapParameters_Warnings.html

> AutofixResult iteration #0: /bootstrapParameters/BootstrapParameters_Warnings.html
    ...
    ␊
    		...
    		data-sap-ui-flexibility-services="true"␊
    		data-sap-ui-frame-options="allow"␊
    		data-sap-ui-on-init="console.log('Ready')"␊
    		data-sap-ui-log-level="INFO"␊
    		data-sap-ui-resource-roots='{"sap.ui.demo.todo": "./"}'␊
    		data-sap-ui-animation-mode="full"␊
    		data-sap-ui-binding-syntax="complex"␊
...
> LintResult: bootstrapParameters/BootstrapParameters_Warnings.html
    ...
    [
      {
        ...
        messages: [
          ...
          },
          {
            column: 3,
            line: 21,
            message: 'Abandoned bootstrap parameter \'data-sap-ui-xx-no-less\' should be removed',
            ruleId: 'no-deprecated-api',
            severity: 1,
            ui5TypeInfo: undefined,
          },
...
> AutofixResult iteration #1: /coreApi/DeprecatedCoreApi.js
    ...
    `sap.ui.define(["sap/ui/core/Core", "sap/ui/base/Object", "sap/m/Button", "sap/ui/core/Component", "sap/ui/core/Control", "sap/ui/core/Element", "sap/ui/core/EventBus", "sap/ui/core/IntervalTrigger",␊
     "sap/ui/core/Lib", "sap/ui/core/StaticArea", "sap/ui/core/Theming", "sap/ui/Device",], function (CoreRenamed, BaseObject, Button, Component, Control, Element, EventBus, IntervalTrigger, Lib, StaticArea, Theming, Device) {␊
    	const async = true;␊
    ...
    ␊
    	...
    	BaseObject.isObjectA(Button, "sap.m.Button");␊
    });␊
    `
    ...
    [
      {
        ...
        messages: [
          ...
          },
          {
            ...
            messageDetails: 'Lib.init (https://ui5.sap.com/1.136/#/api/sap.ui.core.Lib)',
            ruleId: 'no-deprecated-api',
            severity: 2,
            ui5TypeInfo: undefined,
          },
...
> AutofixResult iteration #1: /coreApi/DeprecatedCoreApiWithoutImport.js
    ...
    `sap.ui.define(["sap/m/Button", "sap/ui/base/Object", "sap/ui/core/Component", "sap/ui/core/Control", "sap/ui/core/Core", "sap/ui/core/Element", "sap/ui/core/EventBus", "sap/ui/core/IntervalTrigger",␊
     "sap/ui/core/Lib", "sap/ui/core/StaticArea", "sap/ui/core/Theming", "sap/ui/Device"], function(MButton, BaseObject, Component, Control, Core, Element, EventBus, IntervalTrigger, Lib, StaticArea, Theming, Device) {␊
    ...
    ␊
    	...
    	Theming.notifyContentDensityChanged();␊
    	␊
    	var globalBaseObject = BaseObject;␊
    	...
    	BaseObject.isObjectA(Button, "sap.m.Button");␊
    	globalBaseObject.isObjectA(Button, "sap.m.Button");␊
    });␊
    `
...
## General: manifestJson/manifest.json

> AutofixResult iteration #0: /manifestJson/manifest.json
    ...
    ␊
    	"sap.ui5": {␊
    		"models": {␊
    			...
    			"odata-v4-setting-before-synchronizationMode": {␊
    				"type": "sap.ui.model.odata.v4.ODataModel",␊
    				"settings": {␊
    					"autoExpandSelect": true␊
    				}␊
    			},␊
    			"odata-v4-setting-after-synchronizationMode": {␊
    				"type": "sap.ui.model.odata.v4.ODataModel",␊
    				"settings": {␊
    					"autoExpandSelect": true␊
    				}␊
    			},␊
    			"odata-v4-settings-around-synchronizationMode": {␊
    				"type": "sap.ui.model.odata.v4.ODataModel",␊
    				"settings": {␊
    					"autoExpandSelect": true,␊
    					"earlyRequests": true␊
    			...
    			"odata-v4-settings-around-synchronizationMode-inline": {␊
    				"type": "sap.ui.model.odata.v4.ODataModel",␊
    				"settings": {␊
    					"autoExpandSelect": true, "earlyRequests": true␊
    				}␊
    			},␊
...
> LintResult: manifestJson/manifest.json
...
## General: manifestJson/emptyResourcesJs_01/manifest.json

> AutofixResult iteration #0: /manifestJson/emptyResourcesJs_01/manifest.json
...
> LintResult: manifestJson/emptyResourcesJs_01/manifest.json
...
## General: manifestJson/emptyResourcesJs_02/manifest.json

> AutofixResult iteration #0: /manifestJson/emptyResourcesJs_02/manifest.json
    ...
    ␊
    	"sap.ui5": {␊
    		"resources": {␊
    			"css": [{ "uri": "path/to/styles.css" }]␊
    		}␊
    	}␊
    }␊
    `

> LintResult: manifestJson/emptyResourcesJs_02/manifest.json
...
## General: ambiguousEventHandlers/appA/controller/User.controller.ts

> LintResult: ambiguousEventHandlers/appA/controller/User.controller.ts
...
## General: ambiguousEventHandlers/appA/view/User.view.xml

> AutofixResult iteration #0: /ambiguousEventHandlers/appA/view/User.view.xml

    `<mvc:View xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc"␊
    	controllerName="ui5.walkthrough.controller.User">␊
    ␊
    	<!-- Local event handler should be resolved to the closest controller path (appA) -->␊
    	<Button press=".onPressFancyButtonA" /> <!-- Autofix expected -->␊
    ␊
    	<!-- Nested handler property on the controller -->␊
    	<Button press=".handlers.onNestedA" /> <!-- Autofix expected -->␊
    </mvc:View>␊
    `

> LintResult: ambiguousEventHandlers/appA/view/User.view.xml
    ...
    [
      {
        ...
        errorCount: 0,
        fatalErrorCount: 0,
        filePath: 'User.view.xml',
        messages: [],
        warningCount: 0,
      },
    ]

## General: ambiguousEventHandlers/appB/controller/User.controller.ts

> LintResult: ambiguousEventHandlers/appB/controller/User.controller.ts
...
## General: ambiguousEventHandlers/appB/view/User.view.xml

> AutofixResult iteration #0: /ambiguousEventHandlers/appB/view/User.view.xml

    `<mvc:View xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc"␊
    	controllerName="ui5.walkthrough.controller.User">␊
    ␊
    	<!-- Local event handler should be resolved to the closest controller path (appB) -->␊
    	<Button press=".onPressFancyButtonB" /> <!-- Autofix expected -->␊
    ␊
    	<!-- Nested handler property on the controller -->␊
    	<Button press=".handlers.onNestedB" /> <!-- Autofix expected -->␊
    </mvc:View>␊
    `

> LintResult: ambiguousEventHandlers/appB/view/User.view.xml
