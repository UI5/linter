    ...
    [
      {
        ...
        errorCount: 3,
        fatalErrorCount: 0,
        filePath: 'webapp/test/globalFactory0.js',
        messages: [
          {
            column: 1,
            line: 4,
...
> AutofixResult iteration #0: /resources/com/example/app/test/globalFactory1.js

    `function globalFactory(Core) {}␊
    Core.ready(function () {␊
    	sap.ui.require(["sap/ui/core/Core"], globalFactory);␊
    });␊
    `
