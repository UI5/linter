        ...
        messages: [
          {
            column: 12,
            line: 19,
            message: 'The \'async: false\' flag at \'/sap.ui5/rootView/async\' is not supported',
        ...
        messages: [
          {
            column: 12,
            line: 19,
            message: 'The \'async\' flag at \'/sap.ui5/rootView/async\' must be removed when using IAsyncContentCreation interface in manifest version 2',
            messageDetails: 'In manifest version 2, components using sap.ui.core.IAsyncContentCreation interface should not have explicit \'async\' flags. sap.ui.core.IAsyncContentCreation (https://ui5.sap.com/1.136/#/api/sap.ui.core.IAsyncContentCreation)',
            ruleId: 'async-component-flags',
            severity: 2,
            ui5TypeInfo: undefined,
          },
        ...
        messages: [
          {
            column: 16,
            line: 22,
            message: 'The \'async: false\' flag at \'/sap.ui5/routing/config/async\' is not supported',
            messageDetails: 'Setting \'async\' to \'false\' prevents asynchronous loading and is not recommended. Remove the \'async: false\' flag and implement sap.ui.core.IAsyncContentCreation interface for proper asynchronous loading support. Use Asynchronous Loading (https://ui5.sap.com/#/topic/676b636446c94eada183b1218a824717)',
            ruleId: 'async-component-flags',
            severity: 2,
            ui5TypeInfo: undefined,
