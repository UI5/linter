        ...
        messages: [
          {
            ...
            messageDetails: 'Setting \'async\' to \'false\' prevents asynchronous loading and is not recommended. Remove the \'async\' flag and verify that the sap.ui.core.IAsyncContentCreation interface is implemented for proper asynchronous loading support. Use Asynchronous Loading (https://ui5.sap.com/#/topic/676b636446c94eada183b1218a824717)',
