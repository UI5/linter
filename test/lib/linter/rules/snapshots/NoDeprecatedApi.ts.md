        ...
        messages: [
          {
            ...
            messageDetails: 'Setting \'async\' to \'false\' prevents asynchronous loading and is not recommended. Set \'async: true\' or remove the \'async\' flag and implement the sap.ui.core.IAsyncContentCreation interface for proper asynchronous loading support. Use Asynchronous Loading (https://ui5.sap.com/#/topic/676b636446c94eada183b1218a824717)',
